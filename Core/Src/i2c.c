...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* Configure I2C1 TX/RX DMA channels and I2C event/error interrupts.
   * HAL_I2C_Mem_Read_DMA uses TX DMA for register address phase
   * and RX DMA for data phase; both TX and RX DMA are required. */
  {
